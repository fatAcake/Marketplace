...
{
    /// <inheritdoc />
    public partial class DadAdedede : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldDiscount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    NewDiscount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ChangedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ChangedBy = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceDiscountHistory", x => x.Id);
                    table.ForeignKey(
